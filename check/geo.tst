...
pnt(pnt[line[0,x+i*y+sqrt(x*x+y*y)],56,a]),
pnt(pnt[line[1,1+x+i*y-1-sqrt((1-x)*(1-x)+y*y)],56,b]),
pnt(pnt[line[x+i*y,x+i*y+(-x-i*y)*sqrt((x-1)*(x-1)+y*y)+(-x-i*y+1)*sqrt(x*x+y*y)],56,c]),
