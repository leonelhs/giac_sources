...
namespace giac {
  ...
  bool aberth(const vecteur & P0,vecteur & R,vecteur & rayon,int N,double eps,bool isolate,bool do_exact,GIAC_CONTEXT);
  int mps_solve(const vecteur & P,vecteur & R,vecteur & rayon,double eps,GIAC_CONTEXT);
