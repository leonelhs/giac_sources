...
CXXFLAGS = -g -O2 -U_GLIBCXX_ASSERTIONS -I../fltk-1.3.8 -I./fltk-1.3.8 -fno-strict-aliasing -DGIAC_GENERIC_CONSTANTS -DTIMEOUT -DHAVE_LIBMICROPYTHON -fpermissive -DQUICKJS
CYGPATH_W = echo
DATADIRNAME = share
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
...
FLTK_LIBS = -lfltk_images -ljpeg -lpng -lz -lfltk -lfltk_gl -lXrender -lXext -lXft -lfontconfig -lXinerama -lXfixes -lXcursor -lX11 -lGL -lcurl -lsamplerate -lglpk -lao -llapack -lblas -lgfortran -ldl -lpng16 -lm -lecm -lmpfi -lmpfr -lgmp  
GENCAT = gencat
GINSH_LIBS = -lreadline -lncurses -lcurl -lsamplerate -lglpk -lao -llapack -lblas -lgfortran -ldl -lpng16 -lm -lecm -lmpfi -lmpfr -lgmp 
GLIBC2 = yes
GLIBC21 = yes
GLPK_LIBS = 
GMPXX_LIBS = -lgmpxx
...
LDFLAGS =  -Lfltk-1.3.8/lib  -L. -L.. -lmicropython
LEX = flex
LEXLIB = 
...
LIBINTL = 
LIBOBJS = 
LIBS = -lrt -lpthread -lnauty -lcliquer -lusb-1.0 -lcurl -lsamplerate -lglpk -lao -llapack -lblas -lgfortran -ldl -lpng16 -lm -lecm -lmpfi -lmpfr -lgmp 
LIBTERMCAP = -lncurses
