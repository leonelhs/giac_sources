...
ce point par par une affectation \`a un nom de variable, par exemple 
{\tt M:=...}.\\
On \'ecrit alors :\\
  {\tt lieu(M,P)}\\
{\bf Exemple 1} :\\
...
\begin{center}\includegraphics[width=8cm]{th1968d}\end{center}
...
segment(C,L);
\end{verbatim}
\begin{center}\includegraphics[width=10cm]{th1968}\end{center}
...
commandes :
\begin{center}\includegraphics[width=\textwidth]{th1968w}\end{center}
...
\end{verbatim}
On obtient :
\begin{center}\includegraphics[width=\textwidth]{rota}\end{center}
...
\begin{center}\includegraphics[width=\textwidth]{rotat}\end{center}
On a donc :\\
...
\end{verbatim}
On obtient :
\begin{center}\includegraphics[width=\textwidth]{simili}\end{center}
