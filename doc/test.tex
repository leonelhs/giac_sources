...
\title {Examples of interactive computations inside a \LaTeX\ file compiled to HTML and PDF.}
...
computations are done with the computer algebra system Giac. If you are
on linux, you can compile to HTML and PDF by calling {\tt icas} instead
of {\tt hevea} ({\tt icas} will call hevea and pdflatex).
